...
<link rel='stylesheet' href='/css/pygments_${bf.config.site.syntax_highlight.style}.css' type='text/css' />
"""
...
def sort_into_categories():
    ...
    for category in categories:
        category_posts = [post for post in blog.posts if \
